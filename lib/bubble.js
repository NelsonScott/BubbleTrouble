(function(){
  var Bubble = BubbleTrouble.Bubble = function(pos, vel, r, color, game){
    this.context = game.context;
    BubbleTrouble.MovingObject.call(this, pos, vel, r, color, game);
  }
  ...
  Bubble.prototype.split = function(){
    ...
    this.game.addObject(new BubbleTrouble.Bubble(leftPos, [-3.5, -12], this.r/2, this.color, this.game));
    this.game.addObject(new BubbleTrouble.Bubble(rightPos, [3.5, -12], this.r/2, this.color, this.game));
    this.game.remove(this);
  }
})()
