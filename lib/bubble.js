(function(){
  ...
  Bubble.prototype.split = function(){
    ...
    this.game.addObject(new BubbleTrouble.Bubble(leftPos, [-4, -10], this.r/2, this.game));
    this.game.addObject(new BubbleTrouble.Bubble(rightPos, [4, -10], this.r/2, this.game));
    this.game.remove(this);
  }
})()
